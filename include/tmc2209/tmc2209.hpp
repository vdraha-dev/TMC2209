...
#include <inttypes.h>
#include <transport/interface.hpp>
...
public:
	...
	void setHardwareEnablePin(gpio_num_t hardware_enable_pin);
	void enable();
	void disable();
	...
	private:
	transport::interface::Transport * m_transport;
	SerialAddress m_serial_address;
	gpio_num_t m_hardware_enable_pin;
	...
	DriverCurrent m_driver_current;
	...
	CoolConfig m_cool_config;
	bool m_cool_step_enabled;
	...
	ChopperConfig m_chopper_config;
